...
// console.log(forecastDay[i]);
// console.log(new Date(forecastDay[i].date).getDay());
// console.log(days[new Date(forecastDay[i].date).getDay()]);
// console.log(forecastDay[i].day.maxtemp_c);
// console.log(forecastDay[i].day.mintemp_c);
// console.log(forecastDay[i].day.condition.icon);
// console.log(forecastDay[i].day.condition.text);
const cities = [
  "Cairo",
  "Alexandria",
  "Giza",
